...
private[spark] trait DriverPodKubernetesCredentialsMounterProvider {
  ...
  def getDriverPodKubernetesCredentialsMounter(kubernetesAppId: String)
      : DriverPodKubernetesCredentialsMounter
}

private[spark] class DriverPodKubernetesCredentialsMounterProviderImpl(sparkConf: SparkConf)
    extends DriverPodKubernetesCredentialsMounterProvider {

  override def getDriverPodKubernetesCredentialsMounter(kubernetesAppId: String)
      : DriverPodKubernetesCredentialsMounter = {
